        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-5 mb-6">
            <div className="flex flex-col">
              ...
              >
                <div className="w-12 h-12 rounded-full bg-[#01C0C8]/15 border border-[#01C0C8]/40 flex items-center justify-center mb-3">
                  <UserPlus className="text-[#01C0C8] w-6 h-6" />
                </div>
          ...
          {/* Search Section */}
          <div
            className="flex flex-wrap items-center gap-4 mb-4 relative"
            ref={suggestionRef}
          >
          ...
          <div className="space-y-4 mb-8">
            {selectedProcedures.map((proc) => (
              ...
              >
                {/* Header Row */}
                <div className="bg-[#0F3B46] px-4 py-3 flex items-center justify-between border-b border-gray-600">
                  <div className="flex items-center gap-2 text-sm font-semibold">
                    <ChevronUp className="w-4 h-4" /> {proc.category}
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-bold">
                      ${proc.amount.toFixed(2)}
                    </span>
                    <button
                ...
                <table className="w-full text-xs text-left border-collapse">
                  <thead className="bg-[#0a303a] text-gray-300">
                    <tr>
                    <th className="px-4 py-3 font-normal border-r border-gray-600">Item Code</th>
                    <th className="px-4 py-3 font-normal border-r border-gray-600">Description</th>
                    <th className="px-4 py-3 font-normal text-right border-r border-gray-600">Amount</th>
                    <th className="px-4 py-3 font-normal text-right border-r border-gray-600">Gap</th>
                    <th className="px-4 py-3 font-normal border-r border-gray-600">Fee level</th>
                    <th className="px-4 py-3 font-normal text-right border-gray-600">Line total</th>
                    </tr>
                  </thead>
                  <tbody className="bg-[#0E2238]">
                    <tr className="border-t border-gray-600">
                      <td className="px-4 py-4 border-r border-gray-600">{proc.code}</td>
                      <td className="px-4 py-4 text-gray-300 border-r border-gray-600">
                        {proc.description}
                      </td>
                      <td className="px-4 py-4 text-right border-r border-gray-600">
                        ${proc.amount.toFixed(2)}
                      </td>
                      <td className="px-4 py-4 text-right border-r border-gray-600">
                        {proc.gap.toFixed(2)}
                      ...
                      <td className="px-4 py-4 border-r border-gray-600">
                        <div className="relative inline-block w-32">
                          <select
                            value={proc.feeLevel}
                            onChange={(e) =>
                              updateRowFeeLevel(proc.id, e.target.value)
                            }
          ...
          <div className="flex flex-col md:flex-row justify-between items-start">
            ...
            <div className="w-full max-w-xs mt-8 md:mt-0">
              <div className="border border-gray-600 rounded-lg p-5 bg-[#01C0C8]/15 space-y-3">
                ...
                <div className="flex justify-between items-center pt-2 border-t border-gray-600 font-bold">
